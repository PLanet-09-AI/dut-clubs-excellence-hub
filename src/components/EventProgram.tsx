    ...
    <section id="program" className="relative z-10 mx-auto max-w-7xl px-6 py-24">
      <div className="mb-14 max-w-2xl">
        ...
        <p className="mt-5 text-muted-foreground">
          From the first sip of sparkling wine to the final dance, the evening unfolds with the precision
          of a symphony — and the warmth of a homecoming.
        </p>
      </div>
            ...
            <div className="overflow-hidden rounded-3xl border border-primary/30 bg-gradient-to-br from-card to-secondary/40">
              <div className="relative aspect-[4/3] overflow-hidden">
                <iframe
                  ...
                  src="https://www.openstreetmap.org/export/embed.html?bbox=31.022%2C-29.857%2C31.044%2C-29.847&layer=mapnik&marker=-29.852%2C31.033"
