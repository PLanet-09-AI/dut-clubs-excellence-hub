...
const venueFacts = [
  { icon: MapPin, label: "Address", value: "76 Steve Biko Road, DUT Sports Center" },
  { icon: Car, label: "Parking", value: "Secure on-site · Shuttle from Steve Biko Campus 17:30" },
  { icon: Accessibility, label: "Access", value: "Step-free entrance · BSL interpreter on stage" },
    ...
    <section id="program" className="relative z-10 mx-auto max-w-7xl px-6 py-24">
      <div className="mb-14 max-w-2xl">
        ...
        <p className="mt-5 text-muted-foreground">
          Judges will attend one of two scheduled sessions. Choose your session and experience the SALEA 2026 awards ceremony
          ...
          <div className="sticky top-8 space-y-6">
            <div className="overflow-hidden rounded-3xl border border-primary/30 bg-gradient-to-br from-card to-secondary/40">
              ...
              <div className="p-6">
                ...
                <h3 className="mt-2 font-serif text-3xl font-bold">DUT Sports Center</h3>
                <p className="mt-2 flex items-center gap-2 text-sm text-muted-foreground">
                  <Clock className="h-4 w-4 text-primary" />
                  Doors open 18:00 · Curtain 19:00 sharp
                </p>
              </div>
            </div>
