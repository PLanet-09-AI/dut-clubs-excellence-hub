...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="steps">
            <h3>How to Log In:</h3>
            <ol>
                <li>Go to <strong>${SITE_URL}</strong></li>
                <li>Click Login</li>
                <li>Enter your email and temporary password</li>
                <li>Once logged in, find "Change Password" in the menu</li>
        ...
        <p>Questions? Contact: <strong>KholekaM@dut.ac.za</strong></p>
    </div>
    
    <div class="footer">
        <p>DUT Excellence Awards © 2026</p>
    </div>
</div>
</body>
</html>`;
